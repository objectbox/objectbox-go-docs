---
title: "Golang Database - ObjectBox Golang"
description: "ObjectBox Go is a lean NoSQL Golang database for persisting objects. It is designed to give you high performance and easy native Go APIs on any POSIX-system ..."
keywords:
  - objectbox
  - database
  - readme
...
<TechnicalArticleSchema
  headline="Golang Database - ObjectBox Golang"
  description="ObjectBox Go is a lean NoSQL Golang database for persisting objects. It is designed to give you high performance and easy native Go APIs on any POSIX-system ..."
  url="https://golang.objectbox.io//README"
...
* New Query methods: [Limit, Offset](queries#limit-offset-and-pagination-a-id-limit-offset-a)
* New Query methods: [Set\*Params (type-based) ](queries#reusing-queries-and-parameters-a-id-reusing-queries-and-parameters-a)- to run a cached query with custom  parameters
