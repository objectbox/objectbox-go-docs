---
title: "Transactions in ObjectBox Golang"
description: "ObjectBox is a fully transactional Go database, fully ACID compliant. ObjectBox gives you high performance object persistence without sacrificing atomicity, ..."
keywords:
  - objectbox
  - database
  - transactions
...
<TechnicalArticleSchema
  headline="Transactions in ObjectBox Golang"
  description="ObjectBox is a fully transactional Go database, fully ACID compliant. ObjectBox gives you high performance object persistence without sacrificing atomicity, ..."
  url="https://golang.objectbox.io//transactions"
