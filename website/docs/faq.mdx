---
title: "ObjectBox Golang FAQ"
description: "ObjectBox DB FAQ for Golang. Find answers to: How is ObjectBox different from BoltDB (bolt/bbolt) or Badger? Couldn't I just use JSON to store data? and many..."
keywords:
  - objectbox
  - database
  - faq
...
<TechnicalArticleSchema
  headline="ObjectBox Golang FAQ"
  description="ObjectBox DB FAQ for Golang. Find answers to: How is ObjectBox different from BoltDB (bolt/bbolt) or Badger? Couldn't I just use JSON to store data? and many..."
  url="https://golang.objectbox.io//faq"
...
Also, ObjectBox knows the "inside" of objects; and allows to query for struct fields ("properties"). It also manages indexing for you, you just have to [specify which properties should be indexed](entity-annotations#entity-annotations).