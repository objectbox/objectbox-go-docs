---
title: "Relations in ObjectBox Golang"
description: "ObjectBox db supports relations. Learn all about To-One, To-Many, One-to-Many, Many-to-Many relations and lazy loading for ObjectBox Go. Relations are initia..."
keywords:
  - objectbox
  - database
  - relations
...
<TechnicalArticleSchema
  headline="Relations in ObjectBox Golang"
  description="ObjectBox db supports relations. Learn all about To-One, To-Many, One-to-Many, Many-to-Many relations and lazy loading for ObjectBox Go. Relations are initia..."
  url="https://golang.objectbox.io//relations"
...
![To-One-relations](/img/assets/to-one-relations-2.png)
...
![one to many](/img/assets/one-to-many.png)
...
![many to many](/img/assets/many-to-many2.png)
