---
title: "Queries in ObjectBox Golang"
description: "Easily build Go queries in ObjectBox with the ObjectBox builder APIs. ObjectBox queries help you quickly find objects matching criteria you've specified."
keywords:
  - objectbox
  - database
  - queries
...
<TechnicalArticleSchema
  headline="Queries in ObjectBox Golang"
  description="Easily build Go queries in ObjectBox with the ObjectBox builder APIs. ObjectBox queries help you quickly find objects matching criteria you've specified."
  url="https://golang.objectbox.io//queries"
