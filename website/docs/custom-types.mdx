---
title: "Custom Types in ObjectBox Golang"
description: "Sometimes, you need to store a type that can't be handled out of the box. ObjectBox let's you define a custom converter (a pair of functions) that takes care..."
keywords:
  - objectbox
  - database
  - custom types
...
<TechnicalArticleSchema
  headline="Custom Types in ObjectBox Golang"
  description="Sometimes, you need to store a type that can't be handled out of the box. ObjectBox let's you define a custom converter (a pair of functions) that takes care..."
  url="https://golang.objectbox.io//custom-types"
